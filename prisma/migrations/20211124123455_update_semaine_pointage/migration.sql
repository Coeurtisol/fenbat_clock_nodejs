/*
  ...
  - You are about to drop the column `hour` on the `pointage` table. All the data in the column will be lost.
  ...
  - Added the required column `moment` to the `Pointage` table without a default value. This is not possible if the table is not empty.
  - Added the required column `valeur` to the `Pointage` table without a default value. This is not possible if the table is not empty.
  - Added the required column `annee` to the `Semaine` table without a default value. This is not possible if the table is not empty.
  - Added the required column `numero` to the `Semaine` table without a default value. This is not possible if the table is not empty.
...
-- AlterTable
ALTER TABLE `pointage` DROP COLUMN `hour`,
    ADD COLUMN `date` DATETIME(3) NOT NULL,
    ADD COLUMN `moment` BOOLEAN NOT NULL,
    ADD COLUMN `valeur` DOUBLE NOT NULL,
    MODIFY `entiteId` INTEGER NULL,
    MODIFY `affaireId` INTEGER NULL;

-- AlterTable
ALTER TABLE `semaine` ADD COLUMN `annee` INTEGER NOT NULL,
