/*
  ...
  - You are about to drop the column `fichierPDF` on the `semaine` table. All the data in the column will be lost.
...
-- AlterTable
ALTER TABLE `etatsemaine` MODIFY `id` INTEGER NOT NULL;

-- AlterTable
ALTER TABLE `permission` MODIFY `id` INTEGER NOT NULL;

-- AlterTable
ALTER TABLE `semaine` DROP COLUMN `fichierPDF`,
    ADD COLUMN `PDFemploye` VARCHAR(191) NULL,
    ADD COLUMN `PDFresponsable` VARCHAR(191) NULL;
