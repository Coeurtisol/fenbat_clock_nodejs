...
-- AlterTable
ALTER TABLE `article` MODIFY `categorieId` INTEGER NULL;
...
-- AddForeignKey
ALTER TABLE `Article` ADD CONSTRAINT `Article_categorieId_fkey` FOREIGN KEY (`categorieId`) REFERENCES `Category`(`id`) ON DELETE SET NULL ON UPDATE CASCADE;
