...
-- AlterTable
ALTER TABLE `affaire` ADD COLUMN `clientAffaireId` INTEGER NULL;
...
-- AddForeignKey
ALTER TABLE `Affaire` ADD CONSTRAINT `Affaire_clientAffaireId_fkey` FOREIGN KEY (`clientAffaireId`) REFERENCES `ClientAffaire`(`id`) ON DELETE SET NULL ON UPDATE CASCADE;
