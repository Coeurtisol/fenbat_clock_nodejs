/*
  ...
  - You are about to drop the column `assignedAt` on the `_articletofournisseur` table. All the data in the column will be lost.
  - You are about to drop the column `assignedBy` on the `_articletofournisseur` table. All the data in the column will be lost.
...
-- AlterTable
ALTER TABLE `_articletofournisseur` DROP COLUMN `assignedAt`,
