/*
  ...
  - You are about to drop the column `panier` on the `pointage` table. All the data in the column will be lost.
...
-- AlterTable
ALTER TABLE `pointage` DROP COLUMN `panier`;

-- AlterTable
ALTER TABLE `semaine` MODIFY `commentaire` TEXT NULL;
